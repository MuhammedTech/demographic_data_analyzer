...
def calculate_demographic_data(print_data=True):
    ...
    rich = df[df['salary'] == '>50K'].groupby('native-country')['native-country'].count()
    percentage = round((rich/total_population)*100,1)
    ...
    top_IN_occupation = df.loc[df['native-country'] == 'India'].groupby('occupation').salary.count().idxmax()
